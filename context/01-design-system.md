...
| 항목 | 잠긴 값 | 잠근 날짜 |
|---|---|---|
| 컬러 팔레트 | **Logo Brand v2 — 화이트톤 + 네이비 + 크림슨** | 2026-05-18 (재잠금 v2) |
| 분위기 키워드 | 따뜻한 / 환영하는 / 모던한 / 영상 중심 | 2026-05-18 |
| 헤딩 폰트 | Pretendard (세리프 사용 안 함) | 2026-05-18 |
| 헤로 영상 처리 | Unsplash/Pexels 대체 영상 + 모바일 포스터 | 2026-05-18 |
| 연혁 표기 | **SINCE 1973** (로고 기준) | 2026-05-18 (정정) |

## 1. 컬러 팔레트 — LOCKED: Logo Brand v2 (화이트톤)
