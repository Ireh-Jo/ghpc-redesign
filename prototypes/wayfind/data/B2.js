...
window.FLOOR_B2 = {
  ...
  transfers: [
    ...
    { id:'stair_green', kind:'stairs',   at:[726,505],  label:'중앙서 계단' }, // 발판 중앙 핑크에 부착. [700,500]은 좌/중앙 핑크 정중간이라 왼쪽벽으로 snap돼 선이 계단 옆으로 흘렀음
  ...
  rooms: [
    ...
    { code:'B249', name:'제1교육실', door:[1390,360], sel:true, area:{rect:[1363,130,249,233]} }, // 입구=제2교육실 우측·북동계단 옆·한나실 맞은편(기존[1488,246]은 고립 픽셀→경로없음)
    ...
    { code:'B201', name:'글로브홀', door:[1320,620], sel:true, hall:true, // 입구=키즈그라운드와 한나실 사이 통로(기존[1450,890] 아래쪽 오인)
    ...
    { code:'B212', name:'스튜디오', door:[895,918],  sel:true, area:{rect:[807,767,176,142]} }, // 입구=아래쪽 복도(기존 중앙[895,838]은 우측 복도에 snap)
    ...
    { code:'B227', name:'청년회실', door:[1393,960], sel:true, area:{rect:[1342,962,102,141]} }, // 입구=영역 위쪽(기존[1393,1032] 왼쪽 오인)
