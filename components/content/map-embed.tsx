...
export function MapEmbed({ wayfindingHref }: { wayfindingHref: string }) {
  return (
    <>
      <div className="relative mb-6 aspect-video overflow-hidden border border-brand-line bg-brand-surface">
        <div className="absolute inset-0 z-10 flex items-center justify-center">
          <div className="text-center">
            <div className="btn-round mx-auto mb-3 flex h-12 w-12 items-center justify-center bg-brand-accent text-white">
      ...
      <Link
        href={wayfindingHref}
        className="btn-round inline-flex items-center gap-2 border border-brand-line px-5 py-3 text-[13px] font-bold tracking-widest text-brand-ink transition-colors hover:border-brand-accent hover:text-brand-accent"
      >
